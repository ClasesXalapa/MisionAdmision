...
// These providers remain available so the temporarily hidden backup and
// diagnostics screens continue to compile. They are not instantiated unless
// one of those screens is restored to the router and opened by the user.
...
final supportDiagnosticsServiceProvider =
    Provider<SupportDiagnosticsService>((ref) {
